...
class NameList extends StatelessWidget {
  ...
  Widget _buildListItem(String name, String info, IconData iconData) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF063d4e), // Color de fondo
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 16.0), // Separación entre el círculo y el texto
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4.0), // Espaciado entre el nombre y la información
                Text(
                  info,
                  style: const TextStyle(
                    color: Colors.white,
  ...
  Widget _buildCircleAvatar(String name) {
    ...
    return CircleAvatar(
      backgroundColor: const Color(0xFFC4C4C4), // Color gris
      child: Text(
        initials,
        style: const TextStyle(
