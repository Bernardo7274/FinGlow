...
import 'package:flutter_bloc/flutter_bloc.dart'; // Import necesario para BlocProvider y BlocBuilder
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => LoginBloc(
        LoginFormData(LoginRepositoryImpl()),
      )..add(LoadLoginDataEvent()),
      child: Scaffold( // Agregado Scaffold para manejar correctamente el contexto
        body: Column(
          children: <Widget>[
            BlocBuilder<LoginBloc, LoginEvent>(
