...
class BasicCardView extends StatefulWidget {
  const BasicCardView({super.key});

  @override
  State<BasicCardView> createState() => _BasicCardViewState();
}

class _BasicCardViewState extends State<BasicCardView> {
  int selectedIndex = 0;
            ...
            children: <Widget>[
              Center(
                child: Container(
                  ...
                  child: Image.asset(
                    'assets/images/Tarjeta_Basic_virtual_2.png',
                    width: 300,
                    fit: BoxFit.contain,
                  ),
                ),
              ...
              Row(
                ...
                children: <Widget>[
                  _buildIconButton('assets/icons/icon4.png', 'Consultar \n NIP'),
                  _buildIconButton('assets/icons/icon5.png', 'Apagar \n tarjeta'),
                  _buildIconButton(
        ...
        InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: const Color.fromRGBO(64, 162, 241, 150), // Color del borde
